...
import 'package:viral/widgets/r_category.dart';
...
class  ReviewPPage extends StatefulWidget {

  @override
  _ReviewPPageState createState() => _ReviewPPageState();
}

class _ReviewPPageState extends State<ReviewPPage> {
  final _valueList = ['포인트 지급', '협찬', '후기작성'];
  var _selectedValue = '후기작성';
